...
print(add_all_nums(1, 'two', 3))  # All arguments must be numbers.
# Write a function which generates a list of seven random numbers between 0-9.
# import random
...
# print(generate_random_numbers())  # e.g., [3, 7, 1, 0, 5, 2, 8]
...
print(solve_quadratic_eqn(1, 0, 1))   # No real roots.
...
def capitalize_list_items1(lst):
...
print(evens_and_odds(100))  
# Declare a function named factorial, it takes a whole number as a parameter and it return a factorial of the number.
def factorial(n):
    if n < 0:
...
print(are_all_items_unique([1, 2, 2, 4]))  # False
...
def is_valid_python_variable(var_name):
    ...
    if not var_name.isidentifier() or keyword.iskeyword(var_name):
        return False
    return True
print(is_valid_python_variable("my_var"))  # True
print(is_valid_python_variable("2nd_var"))  # False
print(is_valid_python_variable("for"))      # False
...
def most_populated_countries(data, n=10):
    ...
    most_populated = [(country["name"], country["population"]) for country in sorted_countries[:n]]
